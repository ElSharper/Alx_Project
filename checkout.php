...
<section class="checkout-orders">
   ...
   <div class="heading text-center">
      ...
      ?>
         ...
         <div class="grand-total">Grand Total : <span><?= $grand_total; ?> USD </span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputform-control">
            ...
            <input type="text" name="street" placeholder="Street name" class="form-control" maxlength="50" required>
         </div>
         <div class="inputform-control">
            <span>City :</span>
            <input type="text" name="city" placeholder="Casa" class="form-control" maxlength="50" required>
         </div>
         <div class="inputform-control">
            <span>Province:</span>
            <input type="text" name="state" placeholder="Casa" class="form-control" maxlength="50" required>
         </div>
         <div class="inputform-control">
            <span>Country :</span>
            <input type="text" name="country" placeholder="Morocco" class="form-control" maxlength="50" required>
         </div>
         <div class="inputform-control">
            <span>ZIP CODE :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 56400" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="form-control" required>
         </div>
      
      <div>
      <input type="submit" name="order" class="def-btn <?= ($grand_total > 1)?'':'disabled'; ?>" value="place order">
      </div>
   </form>
